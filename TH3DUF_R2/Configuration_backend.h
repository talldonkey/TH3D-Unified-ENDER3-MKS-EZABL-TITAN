...
//=================================================================================
//=================================================================================
//My Custom Ender3 Settings -> Based on Artillery
#if ENABLED(TALLDONKEY_ENDER3)
  #ifndef MOTHERBOARD
    #define MOTHERBOARD BOARD_MKS_GEN_L
  #endif
...
// Newest R2.8 firmware sets these by default and removes these redunant defines
//#define NEW_JERK_CONTROL
//#define NEW_ACCELERATION_CONTROL
// Already defined in configuration.h
//#define LINEAR_ADVANCE
//#define EZABL_FASTPROBE
//#define BABYSTEP_OFFSET
